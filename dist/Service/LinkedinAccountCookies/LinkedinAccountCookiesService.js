...
class LinkedinAccountCookiesService {
    ...
    async updateBusyAccount(_id, isBusy, getCandidate, timeStamp) {
        return await LinkedinAccountCookiesModel_1.default.findByIdAndUpdate(_id, { isBusy, getCandidate, updatedAt: timeStamp }, { new: true });
    }
